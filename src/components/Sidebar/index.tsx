          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                <NavLink
                  to="/"
                  className={`shadow-1 shadow-[#000] dark:hover:text-black dark:shadow-white group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-gray  dark:text-white ${pathname.includes('dashboard') && 'bg-gray dark:bg-[#9c0a36]'
                    }`}
                >
                  <AiOutlineDashboard />
