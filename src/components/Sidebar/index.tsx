          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`border group relative  flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black dark:text-white duration-300 ease-in-out   ${
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/master"
                              className={({ isActive }) =>
                                'group  relative flex items-center gap-2.5 p-2 rounded-md px-4 font-medium  dark:text-white duration-300 ease-in-out hover:text-blue-700 ' +
                                (isActive && '!bg-[#4b4b64]')
                              }
                            >
                              Master Page
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`border group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-gray dark:text-white ${
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/client"
                              className={({ isActive }) =>
                                'group  relative flex items-center p-2 gap-2.5 rounded-md px-4 font-medium dark:text-white text-black duration-300 ease-in-out hover:text-blue-700 ' +
                                (isActive && '!bg-[#4b4b64]')
                              }
                            >
                              Client page
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`border group relative flex items-center dark:text-white gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-gray  ${
                          (pathname === '/' ||
              ...
              <li>
                <NavLink
                  to="/profile"
                  className={`border group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-gray dark:hover:bg-white ${
                    pathname.includes('profile') && 'bg-gray dark:bg-white  '
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/tables"
                  className={`border group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-gary dark:hover:bg-meta-4 ${
