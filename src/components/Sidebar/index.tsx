  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/master" className="flex items-center gap-5">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`border group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-gray dark:hover:bg-meta-4 ${(pathname === '/' ||
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/master"
                              className={({ isActive }) =>
                                'group  relative flex items-center gap-2.5 rounded-md px-4 font-medium text-black duration-300 ease-in-out hover:text-blue-700 ' +
              ...
              <li>
                <NavLink
                  to="/calendar"
                  className={`border group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-gray dark:hover:bg-meta-4 ${pathname.includes('calendar') &&
                    'bg-gray dark:bg-meta-4'
                    }`}
                >
                  <svg
              ...
              <li>
                <NavLink
                  to="/profile"
                  className={`border group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-gray dark:hover:bg-meta-4 ${pathname.includes('profile') && 'bg-gray dark:bg-meta-4'
                    }`}
                >
                  <svg
                    className="fill-current"
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`border group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-gray dark:hover:bg-meta-4 ${(pathname === '/forms' ||
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              ...
                              className={({ isActive }) =>
                                ' group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-black duration-300 ease-in-out hover:text-blue-800 ' +
                                (isActive && '!text-blue-800')
                              }
                            >
                              Form Elements
              ...
              <li>
                <NavLink
                  to="/tables"
                  className={`border group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-gary dark:hover:bg-meta-4 ${pathname.includes('tables') && 'bg-gray dark:bg-meta-4'
                    }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/settings"
                  className={`border group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-gray dark:hover:bg-meta-4 ${pathname.includes('settings') &&
                    'bg-gray dark:bg-meta-4'
                    }`}
                >
                  <svg
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/chart"
                  className={`border group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-gray dark:hover:bg-meta-4 ${pathname.includes('chart') && 'bg-gray dark:bg-meta-4'
                    }`}
                >
                  <svg
                    className="fill-current"
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`border group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-gray dark:hover:bg-meta-4 ${(pathname === '/ui' || pathname.includes('ui')) &&
                          'bg-gray dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`border group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-gray dark:hover:bg-meta-4 ${(pathname === '/auth' || pathname.includes('auth')) &&
                          'bg-gray dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
