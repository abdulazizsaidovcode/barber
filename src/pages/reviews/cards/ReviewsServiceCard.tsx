...
const ReviewsServiceCard: React.FC<ReviewsServiceCardProps> = ({ data, openModal }) => {
    ...
    return (
        <div className="w-full bg-white p-4 flex md:flex-row flex-col    justify-center items-start shadow-lg rounded-xl dark:bg-[#60606D] text-black dark:text-white mb-4">
