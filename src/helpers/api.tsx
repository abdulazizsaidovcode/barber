...
export const master_gallery_delate: string = `${base_url}gallery/web/canceled/attachmentIds`;
...
export const client_block_put = `${base_url}user/web/client-edit-status`;
...
export const reviews_Confirm = `${base_url}feedback/confirm?feedbackId=`;
